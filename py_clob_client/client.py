...
class ClobClient:
    ...
    def create_market_order_data(
        ...
        return self.builder.create_market_order_data(
            order_args,
            CreateOrderOptions(
                tick_size=tick_size,
                neg_risk=neg_risk,
    ...
    def create_market_order_hash(
        ...
        return self.builder.create_market_order_hash(
            order_args,
            CreateOrderOptions(
                tick_size=tick_size,
                neg_risk=neg_risk,
    ...
    def create_market_order_hash_with_custom_signer(
        ...
        return self.builder.create_market_order_hash_with_custom_signer(
            order_args,
            CreateOrderOptions(
                tick_size=tick_size,
                neg_risk=neg_risk,
    ...
    def create_signed_order_from_signature(
        self, order_data, signature: str, neg_risk: bool = None
    ):
        """
        Creates a SignedOrder from OrderData and signature (r, s, v)
        """
        # If neg_risk is not provided, get it from the token_id
        if neg_risk is None:
            neg_risk = self.get_neg_risk(order_data.tokenId)
            
        return self.builder.create_signed_order_from_signature(
            order_data, signature, self.signer.get_chain_id(), neg_risk
        )
    ...
    def create_signed_order_from_signature_with_custom_signer(
        ...
        return self.builder.create_signed_order_from_signature_with_custom_signer(
            order_data, signature, self.signer.get_chain_id(), neg_risk
        )